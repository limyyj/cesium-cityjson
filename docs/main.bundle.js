...
var ToolwindowComponent = /** @class */ (function (_super) {
    ...
    ToolwindowComponent.prototype.changeMin = function (Min) {
        this.Min = Number(Min);
        this.dataService.MinColor = Number(Min);
        this.changeExtrude();
    };
    ToolwindowComponent.prototype.changeMax = function (Max) {
        this.Max = Number(Max);
