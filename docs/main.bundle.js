...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.maxDiff = function (values) {
        var maxval = values[0];
        var minval = values[0];
    ...
    DataService.prototype.determineAxis = function (points, all_vertices) {
        // split coords and determine plane
        var x = [];
        var y = [];
        points.forEach(function (index) {
            var coords = all_vertices[index];
            x.push(coords[0]);
            y.push(coords[1]);
        });
    ...
    DataService.prototype.triangulatePoly = function (boundaries, all_vertices, epsg, transform, dataSource, color) {
        ...
        // determine axis
        var axis = this.determineAxis(boundaries[0], all_vertices);
        var other_axis = 0;
        if (axis === 0) {
            other_axis = 1;
        }
                ...
                if (1) {
                    ...
                    for (var geom_index = 0; geom_index < obj["geometry"].length; geom_index++) {
                        ...
                        var _loop_3 = function (srf_index) {
                            ...
                            var z = [];
                            boundaries[srf_index][0].forEach(function (coords) {
